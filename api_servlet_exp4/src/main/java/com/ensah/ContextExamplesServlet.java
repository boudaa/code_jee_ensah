...
public class ContextExamplesServlet extends HttpServlet {
	 ...
	 * 
	 * @param rq     : l'objet représentant la requête
	 * @param key    : une chaîne de caractères qui represente la clé à utiliser
	 *               pour référencer l'objet dans le contexte
	 * @param object : l'objet à stocker dans le contexte
	 */
	private void storeObjectInContext(HttpServletRequest rq, String key, Object object) {
	 ...
	 * @param object : l'objet à récupérer du contexte
	 */
	private Object getObjectFromContext(HttpServletRequest rq, String key) {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// En fonction de la valeur de ce paramère on execute l'une des tâches
		// ci-dessous :
		...
		// Tâche 2 : On récupère un objet étudiant de la session
			...
			writeParagraph(response,
					"il faut appeler cette servlet avec un paramètre task qui prend soit store ou get comme valeur");
