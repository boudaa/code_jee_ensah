...
public class TestProgram {
	public static void main(String[] args) {
		...
		try {
			...
			// Création de 3 objets Etudiant tansitoires
			...
			Etudiant etd0 = new Etudiant();
			etd0.setNom("boudaa");
			etd0.setPrenom("Tarik");
			etd0.setCin("B11121");
			etd0.setValeurCalculée(100);
			...
			// On affiche la liste des étudiants en base de données aynt le nom commence par
			// boudaa
			list = dao.finByName("boudaa");

			System.out.println("-------------La liste des étudiants  ayant le nom commence par boudaa-------------");
			for (Etudiant it : list) {
				System.out.println(it);
			}
