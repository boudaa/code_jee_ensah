...
public class CookieExamplesServlet extends HttpServlet {
	 ...
	 */
	private void addCookieToHttpResponse(HttpServletResponse res, String cookieName, String cookieValue) {
	 ...
	 */
	private Cookie[] getAllUserCookies(HttpServletRequest rq) {
